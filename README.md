...
1. git clone https://bitbucket.org/tjyderrien/spp_extended_theory/
...
4. conda activate spp_extended_theory
5. pip install -e <folder_with_setup.py> (can be "." or "spp_extended_theory")
