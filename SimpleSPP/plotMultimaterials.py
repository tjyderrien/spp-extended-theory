...
## ================== PLOT DATABASE ...
Material1, Material2, Wavelength, OldSPPactiveBool, NewSPPactiveBool, SPPperiod, SPPperiodError, SPPdecayDepth1, SPPdecayDepth2, Reflectivity, OpticalPenetration1, OpticalPenetration2, SPPdecayLength, eps1r, eps1c, eps2r, eps2c, k1imag, k2imag, DeltaLsppValue = ExtractDataDb(
    SPPdb)
...
Material1, Material2, Wavelength, OldSPPactiveBool, NewSPPactiveBool, SPPperiod, SPPperiodError, SPPdecayDepth1, SPPdecayDepth2, Reflectivity, OpticalPenetration1, OpticalPenetration2, SPPdecayLength, eps1rM, eps1cM, eps2rM, eps2cM, k1imag, k2imag, DeltaLsppValue = ExtractDataDb(
    SPPdb)
...
print(("DeltaBetaSPP = " + str(
    deltaBetaSPP(wavelength, 1e0 + 0e0j, -49.5738812793e0 + 3.81282698968e0j, 0e0, 0e0, noise, noise)) + " m-1"))
print(("Decay Length SPP = " + str(
    DecayLengthSPP(betaSPP(wavelength, 1e0 + 0e0j, -49.5738812793e0 + 3.81282698968e0j))) + " m"))
print(("DeltaPeriodSPP = " + str(
    deltaPeriodSPP(wavelength, 1e0 + 0e0j, -49.5738812793e0 + 3.81282698968e0j, 0e0, 0e0, noise, noise)) + " m"))
print(("DeltaLspp = " + str(
    deltaLspp(wavelength, 1e0 + 0e0j, -49.5738812793e0 + 3.81282698968e0j, 0e0, 0e0, noise, noise)) + " m"))
# exit()
...
plotDatabaseMaterials(SPPdb, 'Database (1030 nm)', 'MaterialDatabase' + str(wavelength) + 'nm.eps',
                      'Database (1030 nm)', metal)
