...
def Derrien_HRLIPSSonCuFilms(wavelength, thickness_size):
    ...
    #plt.ylim((20E-9,1E-3))
    #plot110, = ax1.plot(np.multiply(1e9,thickness0), np.multiply(1e0,np.abs(lspp0)), 'r+', label=r'SPP period $\Lambda$, branch (-,-)')
    #plot111, = ax1.plot(np.multiply(1e9,thickness1), np.multiply(1e0,np.abs(lspp1)), 'k+', label=r'SPP period $\Lambda$, branch (-,+)')
    #plot112, = ax1.plot(np.multiply(1e9,thickness2), np.multiply(1e0,np.abs(lspp2)), 'b+', label=r'SPP period $\Lambda$, branch (+,-)')
    #plot113, = ax1.plot(np.multiply(1e9,thickness3), np.multiply(1e0,np.abs(lspp3)), 'g+', label=r'SPP period $\Lambda$, branch ( +,+)')
    #ax1.set_yscale('log')
...
wavelength = 400E-9 # 800e-9 # 1030e-9 
