#! /bin/gawk
# in this script, we clearly disregard Imaginary parts
gawk -v eps1re=$2 -v eps1im=$3 -v lambda=$4 '
{
# $4 will be eps2re, $5 is eps2im but is neglected
# condition 1 only 
...
# else { #case of non-absorbing materials
  if( (eps1re*$4 < 0e0) && ($3==lambda) && (eps1re < - $4)) {print $0, eps1re*$4+eps1im*$5}
#   if( (eps1re*$4 < 0e0) && ($3==lambda) && ($4 < - eps1re)) {print $0, eps1re*$4+eps1im*$5}
# }
# condition 2 also
